...
App.controller('workProjectsController', function ($scope) {
    $scope.header = "Work Projects";
});

// post controller
App.controller('personalProjectsController', function ($scope) {
...
// crazy balls controller
App.controller('crazyBallsController', function ($scope) {
    $scope.header = "Crazy Balls";
});
// crazy balls controller
App.controller('blackJackController', function ($scope) {
    $scope.header = "Blackjack";
